...
$string['settings_showonenotenotebook_desc'] = 'Enable or disable the "My OneNote Notebook" link in the block. <br /><b>Note:</b> Requires local_onenote.';
$string['settings_showoutlooksync'] = 'Show Outlook Calendar sync settings link';
$string['settings_showoutlooksync_desc'] = 'Enable or disable the Outlook Calendar sync settings link in the block.';
$string['settings_showpreferences'] = 'Show Settings link';
$string['settings_showpreferences_desc'] = 'Enable or disable the Settings link in the block.';
...
$string['settings_showmanageo365conection'] = 'Show Office 365 connection settings link';
$string['settings_showmanageo365conection_desc'] = 'Enable or disable the Office 365 connection settings link in the block.';
