...
if ($hassiteconfig) {
    ...
    $ADMIN->add('oidcfolder', new admin_externalpage(
        ...
        new url('/auth/oidc/manageapplication.php')
    ));
    ...
    if ($idptype) {
        ...
        $ADMIN->add('oidcfolder', new admin_externalpage(
            ...
            new url('/auth/oidc/binding_username_claim.php')
        ));
    ...
    $authenticationconfigurationurl = new url('/auth/oidc/manageapplication.php');
