...
$string['cfg_stripdomain_key'] = 'Strip Domain';
$string['cfg_stripdomain_desc'] = 'If enabled, the "@domain.com" portion of the UPN will be removed from the username. This needed if the Moodle username is formatted as a sAMAccount name and you cannot change it to the UPN format due to other plugins or integrations.';
