...
$string['cert_source_keyvault'] = 'Azure Key Vault';
$string['clientcertkeyvaulthost'] = 'Client certificate Key Vault host';
$string['clientcertkeyvaulthost_help'] = 'When using <b>certificate</b> from an <b>Azure Key Vault</b>, this is the host name of the Key Vault.';
$string['clientcertkeyvaultname'] = 'Client certificate Key Vault name';
$string['clientcertkeyvaultname_help'] = 'When using <b>certificate</b> from an <b>Azure Key Vault</b>, this is the name of the certificate in the Key Vault. The certificate must be in <b>PEM format</b>.';
$string['clientcertkeyvaultversion'] = 'Client certificate Key Vault version';
$string['clientcertkeyvaultversion_help'] = 'When using <b>certificate</b> from an <b>Azure Key Vault</b>, this is the version of the certificate in the Key Vault.';
$string['clientcertkeyvaultmanagedidclientid'] = 'Client certificate Key Vault managed identity client ID';
$string['clientcertkeyvaultmanagedidclientid_help'] = 'When using <b>certificate</b> from an <b>Azure Key Vault</b>, the authentication to the vault is done via Managed Identity. Use this setting to define the Client ID of the Managed Identity, if the VM has access to multiple identities.';
...
$string['errorkeyvaultcall'] = 'Error during request to Key Vault.';
$string['errormanagedidentitycall'] = 'Error during request to managed identity.';
