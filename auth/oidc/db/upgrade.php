...
function xmldb_auth_oidc_upgrade($oldversion) {
    ...
    if ($oldversion < 2025100602.01) {
        ...
        upgrade_plugin_savepoint(true, 2025100602.01, 'auth', 'oidc');
    }
    ...
    if ($oldversion < 2025100602.02) {
        ...
        utils::add_token_unique_constraint();
        upgrade_plugin_savepoint(true, 2025100602.02, 'auth', 'oidc');
    }
    ...
    if ($oldversion < 2025100602.04) {
        ...
        // Oidc savepoint reached.
        upgrade_plugin_savepoint(true, 2025100602.04, 'auth', 'oidc');
    }

    if ($oldversion < 2025100602.05) {
        \auth_oidc\utils::migrate_removed_icon_choices();
        upgrade_plugin_savepoint(true, 2025100602.05, 'auth', 'oidc');
    }

    if ($oldversion < 2025100602.06) {
        ...
        // Oidc savepoint reached.
        upgrade_plugin_savepoint(true, 2025100602.06, 'auth', 'oidc');
    }
    ...
    if ($oldversion < 2025100603.05) {
        ...
        upgrade_plugin_savepoint(true, 2025100603.05, 'auth', 'oidc');
    }
