...
The plugins currently support Moodle 4.5, 5.0 and 5.1. Support for newer releases of Moodle typically comes a few weeks after the release. The support lifecycle of these plugins tracks the [official support status of Moodle core versions](https://docs.moodle.org/dev/Release_notes), meaning plugins will end support for Moodle versions when those versions reach end of support.
...
## Documentation
The documentation for installing, configuring, and using these plugins is available on Moodle.org [here.](https://docs.moodle.org/501/en/Microsoft_365)
