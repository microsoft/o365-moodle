...
4. To enable the plugin, from the Moodle Administration block, go to Site Administration > Plugins > Repositories > Manage repositories.
5. Locate the "Microsoft 365" repository and select "Enabled and visible" from the "Active?" dropdown menu.
