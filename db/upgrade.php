...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($result && $oldversion < 2016062006.05) {
        if ($dbman->table_exists('local_o365_objects')) {
            $table = new xmldb_table('local_o365_objects');
        ...
        upgrade_plugin_savepoint($result, '2016062006.05', 'local', 'o365');
    }

    if ($result && $oldversion < 2016062006.06) {
        if ($dbman->table_exists('local_o365_objects')) {
            $table = new xmldb_table('local_o365_objects');
        ...
        upgrade_plugin_savepoint($result, '2016062006.06', 'local', 'o365');
    }

    if ($result && $oldversion < 2016062010) {
        ...
        upgrade_plugin_savepoint($result, '2016062010', 'local', 'o365');
    }
