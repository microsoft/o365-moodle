...
function xmldb_auth_oidc_upgrade($oldversion) {
    ...
    if ($result && $oldversion < 2015060111.01) {
        ...
        upgrade_plugin_savepoint($result, '2015060111.01', 'auth', 'oidc');
    }

    if ($result && $oldversion < 2015060112.01) {
        ...
        upgrade_plugin_savepoint($result, '2015060112.01', 'auth', 'oidc');
    }
