...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($result && $oldversion < 2017111307) {
        ...
        upgrade_plugin_savepoint($result, '2017111307', 'local', 'o365');
    }
