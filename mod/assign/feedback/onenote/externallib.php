...
class assignfeedback_onenote_external extends external_api {
  ...
  protected static function validate_feedback_onenote_delete_foruser($contextid, $gradeid, $userid) {
    ...
    $assign = $DB->get_record('assignfeedback_onenote', array('id' => $gradeid ), 'id', MUST_EXIST);
    $user = $DB->get_record('user', array('id' => $userid), 'id', MUST_EXIST);

    return array($contextid, $gradeid ,$userid );
  }
  ...
  public static function feedback_onenote_delete_foruser($contextid,$gradeid,$userid) {
    ...
    $params = self::validate_parameters(self::feedback_onenote_delete_foruser_parameters(), array(
          'contextid' => $contextid,
          'gradeid' => $gradeid,
          'userid' => $userid,
        ));
    ...
    $fs->delete_area_files($contextid, 'assignfeedback_onenote',
