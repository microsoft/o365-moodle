...
if ($hassiteconfig) {
    ...
    $tabs->addtab(LOCAL_O365_TAB_SETUP, get_string('settings_header_setup', 'local_o365'));
    $tabs->addtab(LOCAL_O365_TAB_OPTIONS, get_string('settings_header_options', 'local_o365'));
    $tabs->addtab(LOCAL_O365_TAB_TOOLS, get_string('settings_header_tools', 'local_o365'));
    $settings->add($tabs);
    ...
    if ($tab === LOCAL_O365_TAB_TOOLS) {
        ...
        $label = get_string('settings_options_usersync', 'local_o365');
        $desc = get_string('settings_options_usersync_desc', 'local_o365');
        ...
        $label = get_string('settings_options_features', 'local_o365');
        $desc = get_string('settings_options_features_desc', 'local_o365');
        ...
        $label = get_string('settings_options_advanced', 'local_o365');
        $desc = get_string('settings_options_advanced_desc', 'local_o365');
        ...
        $label = get_string('settings_setup_step1', 'local_o365');
        $desc = get_string('settings_setup_step1_desc', 'local_o365', (object)['oidcsettings' => $oidcsettings->out()]);
        $settings->add(new admin_setting_heading('local_o365_setup_step1', $label, $desc));

        $configkey = get_string('settings_clientid', 'local_o365');
        $configdesc = get_string('settings_clientid_desc', 'local_o365');
        $settings->add(new admin_setting_configtext('auth_oidc/clientid', $configkey, $configdesc, '', PARAM_TEXT));

        $configkey = get_string('settings_clientsecret', 'local_o365');
        $configdesc = get_string('settings_clientsecret_desc', 'local_o365');
        $settings->add(new admin_setting_configtext('auth_oidc/clientsecret', $configkey, $configdesc, '', PARAM_TEXT));

        $label = get_string('settings_setup_step2', 'local_o365');
        $desc = get_string('settings_setup_step2_desc', 'local_o365');
        ...
        $label = get_string('settings_setup_step3', 'local_o365');
        $desc = get_string('settings_setup_step3_desc', 'local_o365');
