...
abstract class oauth2_client extends curl {
    ...
    public static function callback_url() {
        ...
        return new moodle_url('http://gopikalocal.com/admin/oauth2callback.php');
    ...
    protected function request($url, $options = array()) {
    	//Change made to read the onenote token created for running tests
    //	global $CFG;
    	$murl = new moodle_url($url);            	
    	/*$filePath = $CFG->dirroot.DIRECTORY_SEPARATOR."local/onenote/onenotetoken".DIRECTORY_SEPARATOR."onenotetoken.txt";
