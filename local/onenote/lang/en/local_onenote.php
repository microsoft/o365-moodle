...
$string['error_noapiavailable'] = 'No OneNote API is available. If using the Microsoft 365 plugin set, we were not able to contact OneNote. Otherwise, please install local_msaccount.';
