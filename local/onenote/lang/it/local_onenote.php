...
$string['error_noapiavailable'] = 'Nessuna API OneNote disponibile. Se utilizzi il set di plugin di Microsoft 365, non è possibile contattare OneNote. In caso contrario, installa local_msaccount.';
