...
class calendar_subscribed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcalendarsubscribed', 'local_o365');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has subscribed to a calendar (caltype: '{$caltype}' caltypeid: '{$caltypeid}')";
    }
