    ...
    public function output_html($data, $query = '') {
        ...
        $options = [
            TEAMS_GROUP_COURSE_RESET_SITE_SETTING_DO_NOTHING => new \lang_string('settings_course_reset_teams_option_do_nothing',
                'local_o365'),
            TEAMS_GROUP_COURSE_RESET_SITE_SETTING_PER_COURSE => new \lang_string('settings_course_reset_teams_option_per_course',
                'local_o365'),
            TEAMS_GROUP_COURSE_RESET_SITE_SETTING_DISCONNECT => new \lang_string('settings_course_reset_teams_option_force_archive',
                'local_o365'),
        ];
