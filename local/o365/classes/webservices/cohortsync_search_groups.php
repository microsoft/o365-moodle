...
class cohortsync_search_groups extends \external_api {
    ...
    /**
     * Search Microsoft 365 groups using the local cache table.
     *
     ...
     */
    public static function search_groups($query, $offset = 0, $limit = 20) {
        global $DB;

        $params = self::validate_parameters(self::search_groups_parameters(), [
            'query' => $query,
            'offset' => $offset,
            'limit' => $limit,
        ]);
        ...
        $sql = "SELECT objectid AS id, name AS displayname
