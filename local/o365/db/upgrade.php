...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($oldversion < 2021051713) {
        ...
        if ($existingtaskusersynclastdeletesetting != date('Ymd', strtotime('yesterday'))) {
            add_to_config_log(
                ...
                $existingtaskusersynclastdeletesetting,
    ...
    if ($oldversion < 2025100600.01) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2025100600.01, 'local', 'o365');
    }

    if ($oldversion < 2025100600.02) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2025100600.02, 'local', 'o365');
    }

    if ($oldversion < 2025100600.03) {
    ...
    if ($oldversion < 2025100602.03) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2025100602.03, 'local', 'o365');
    }
    ...
    if ($oldversion < 2025100603.02) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2025100603.02, 'local', 'o365');
    }
