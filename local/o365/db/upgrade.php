...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($oldversion < 2024042216) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2024042216, 'local', 'o365');
    }

    if ($oldversion < 2024042217) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2024042217, 'local', 'o365');
    }
