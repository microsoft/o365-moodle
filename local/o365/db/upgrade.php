...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($oldversion < 2015060131.01) {
        ...
        upgrade_plugin_savepoint($result, 2015060131.01, 'local', 'o365');
    }

    if ($result && $oldversion < 2015060132.01) {
    ...
    if ($result && $oldversion < 2015060132.03) {
        if ($dbman->table_exists('local_o365_coursegroupdata')) {
        ...
        upgrade_plugin_savepoint($result, '2015060132.03', 'local', 'o365');
    }

    if ($result && $oldversion < 2015060133.01) {
        ...
        upgrade_plugin_savepoint($result, '2015060133.01', 'local', 'o365');
    }

    if ($result && $oldversion < 2015060136.01) {
