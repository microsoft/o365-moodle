...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($oldversion < 2021051726) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2021051726, 'local', 'o365');
    }
