...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($oldversion < 2025040830.03) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2025040830.03, 'local', 'o365');
    }
    ...
    if ($oldversion < 2025040830.04) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2025040830.04, 'local', 'o365');
    }
    ...
    if ($oldversion < 2025040835.02) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2025040835.02, 'local', 'o365');
    }
