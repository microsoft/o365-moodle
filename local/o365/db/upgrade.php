...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($oldversion < 2020110928) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2020110928, 'local', 'o365');
    }

    if ($oldversion < 2020110929) {
    ...
    if ($oldversion < 2020110932) {
        // Reset last calendar sync run task.
        set_config('calsyncinlastrun', 0, 'local_o365');

        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2020110932, 'local', 'o365');
    }

    if ($oldversion < 2020110933) {
