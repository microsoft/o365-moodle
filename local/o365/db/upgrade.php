...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($oldversion < 2023042411) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2023042411, 'local', 'o365');
    }
    ...
    if ($oldversion < 2023042412) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2023042412, 'local', 'o365');
    }
    ...
    if ($oldversion < 2023042415) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2023042415, 'local', 'o365');
    }
    ...
    if ($oldversion < 2023042426) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2023042426, 'local', 'o365');
    }

    if ($oldversion < 2023042427) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2023042427, 'local', 'o365');
    }

    if ($oldversion < 2023042432) {
        ...
        upgrade_plugin_savepoint(true, 2023042432, 'local', 'o365');
    }

    if ($oldversion < 2023042433) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2023042433, 'local', 'o365');
    }

    if ($oldversion < 2023042434) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2023042434, 'local', 'o365');
    }
