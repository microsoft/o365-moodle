...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($result && $oldversion < 2015011636.02) {
        ...
        upgrade_plugin_savepoint($result, '2015011636.02', 'local', 'o365');
    }

    if ($result && $oldversion < 2015011637.01) {
        ...
        upgrade_plugin_savepoint($result, '2015011637.01', 'local', 'o365');
    }

    if ($result && $oldversion < 2015011637.03) {
        // Create new indexes.
        ...
        upgrade_plugin_savepoint($result, '2015011637.03', 'local', 'o365');
    }

    if ($result && $oldversion < 2015011639) {
        $table = new xmldb_table('local_o365_appassign');
        ...
        upgrade_plugin_savepoint($result, '2015011639', 'local', 'o365');
    }

    if ($result && $oldversion < 2015011641) {
    ...
    if ($oldversion < 2015011650.02) {
        ...
        upgrade_plugin_savepoint(true, 2015011650.02, 'local', 'o365');
    }

    if ($result && $oldversion < 2015011650.03) {
        // Drop index.
        $table = new xmldb_table('local_o365_token');
    ...
    if ($oldversion < 2015011653.02) {
        ...
        upgrade_plugin_savepoint($result, 2015011653.02, 'local', 'o365');
    }

    if ($result && $oldversion < 2015011653.03) {
        if ($dbman->table_exists('local_o365_coursegroupdata')) {
        ...
        upgrade_plugin_savepoint($result, '2015011653.03', 'local', 'o365');
    }
    ...
    if ($result && $oldversion < 2015011657.01) {
        ...
        upgrade_plugin_savepoint($result, '2015011657.01', 'local', 'o365');
    }

    if ($result && $oldversion < 2015011659.05) {
        if ($dbman->table_exists('local_o365_objects')) {
            $table = new xmldb_table('local_o365_objects');
        ...
        upgrade_plugin_savepoint($result, '2015011659.05', 'local', 'o365');
    }

    if ($result && $oldversion < 2015011659.06) {
        if ($dbman->table_exists('local_o365_objects')) {
            $table = new xmldb_table('local_o365_objects');
        ...
        upgrade_plugin_savepoint($result, '2015011659.06', 'local', 'o365');
    }
