...
function xmldb_local_o365_upgrade($oldversion) {
    ...
    if ($oldversion < 2022112816) {
        ...
        // O365 savepoint reached.
        upgrade_plugin_savepoint(true, 2022112816, 'local', 'o365');
    }
    ...
    if ($oldversion < 2022112818) {
        ...
        upgrade_plugin_savepoint(true, 2022112818, 'local', 'o365');
    }

    if ($oldversion < 2022112819) {
        ...
        upgrade_plugin_savepoint(true, 2022112819, 'local', 'o365');
    }

    if ($oldversion < 2022112820) {
