...
/**
 * AMD module for the manage Team connections DataTables initialization.
 *
 * @module     local_o365/teamconnections_datatables
...
define(['jquery', 'core/log'], function($, Log) {
    ...
    return {
        /**
         * Initialize DataTables for the manage Team connections page.
         *
        ...
        init: function(ajaxUrl) {
            ...
            script.onload = function() {
                ...
                $(document).ready(function() {
                    $("#local_o365_teamconnections_table").DataTable({
                        "serverSide": true,
                        "ajax": {
                            "url": ajaxUrl,
                            "dataSrc": "data"
            ...
            script.onerror = function() {
                restoreAmd();
                Log.error('local_o365/teamconnections_datatables: could not load DataTables from ' + script.src);
            };
