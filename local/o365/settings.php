...
if ($hassiteconfig) {
    ...
    if ($tab == LOCAL_O365_TAB_OPTIONS || !empty($install)) {
        ...
        $label = new lang_string('settings_onenote_disable_title', 'local_o365');
        $desc = new lang_string('settings_onenote_desc', 'local_o365');
        $settings->add(new \admin_setting_configcheckbox('local_o365/disableo365onenote', $label, $desc, '0'));
