...
if ($hassiteconfig) {
    ...
    $label = new lang_string('settings_header_options', 'local_o365');
    $desc = '';
    ...
    $label = new lang_string('settings_header_setup', 'local_o365');
    $desc = new lang_string('settings_header_setup_desc', 'local_o365');
    $settings->add(new admin_setting_heading('local_o365_environment', $label, $desc));

    $label = new lang_string('settings_detectoidc', 'local_o365');
    $desc = new lang_string('settings_detectoidc_details', 'local_o365');
