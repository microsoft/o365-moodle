...
if ($hassiteconfig) {
    ...
    if (empty($install)) {
        ...
        $syncsettings->add(new admin_setting_heading('local_o365_sync_nav', '', local_o365_get_settings_nav_html('local_o365_sync')));
        ...
        $syncsettings->add(new admin_setting_configcheckbox(
            'local_o365/support_user_identifier_change', $label, $desc, '0'
        ));
        ...
        $syncsettings->add(new admin_setting_configcheckbox(
            'local_o365/delete_group_on_course_deletion', $label, $desc, '0'
        ));
        ...
        $syncsettings->add(new admin_setting_configcheckbox(
            'local_o365/delete_group_on_course_sync_disabled', $label, $desc, '0'
        ));
        ...
        $options = [
            COURSE_USER_SYNC_DIRECTION_MOODLE_TO_TEAMS => new lang_string(
                'settings_coursesync_sync_moodle_to_teams', 'local_o365'
            ),
            COURSE_USER_SYNC_DIRECTION_TEAMS_TO_MOODLE => new lang_string(
                'settings_coursesync_sync_teams_to_moodle', 'local_o365'
            ),
        ...
        $syncsettings->add(new admin_setting_configselect(
            'local_o365/coursesyncownerrole', $label, $desc, 3, $courseroleoptions
        ));
        ...
        $syncsettings->add(new admin_setting_configselect(
            'local_o365/coursesyncmemberrole', $label, $desc, 5, $courseroleoptions
        ));
        ...
        $syncsettings->add(new toollink('local_o365/cohortsync', $label, $linktext, $linkurl, $desc));
        ...
        $syncsettings->add(new admin_setting_configselect(
            'local_o365/courserequestownerrole', $label, $desc, 3, $courseroleoptions
        ));
        ...
        $syncsettings->add(new admin_setting_configselect(
            'local_o365/courserequestmemberrole', $label, $desc, 5, $courseroleoptions
        ));
        ...
        $advancedsettings->add(new admin_setting_heading('local_o365_advanced_nav', '', local_o365_get_settings_nav_html('local_o365_advanced')));
        ...
        $advancedsettings->add(new toollink('local_o365/tenants', $label, $linktext, $linkurl, $desc));
        ...
        $advancedsettings->add(new toollink('local_o365/healthcheck', $label, $linktext, $linkurl, $desc));
        ...
        $advancedsettings->add(new toollink('local_o365/userconnections', $label, $linktext, $linkurl, $desc));
        ...
        $advancedsettings->add(new toollink('local_o365/teamconnections', $label, $linktext, $linkurl, $desc));
        ...
        $advancedsettings->add(new toollink('local_o365/usermatch', $label, $linktext, $linkurl, $desc));
        ...
        $advancedsettings->add(new toollink('local_o365/maintenance', $label, $linktext, $linkurl, $desc));
        ...
        $advancedsettings->add(new admin_setting_configtext(
            'local_o365/reset_team_name_prefix', $label, $desc, '(archived) ', PARAM_TEXT
        ));
        ...
        $advancedsettings->add(new admin_setting_configtext(
            'local_o365/reset_group_name_prefix', $label, $desc, 'disconnected-', PARAM_TEXT
        ));
        ...
        $advancedsettings->add(new admin_setting_configselect(
            'local_o365/customtheme', $label, $desc, 'boost_o365teams', $options
        ));
        ...
        $sdssettings->add(new admin_setting_heading('local_o365_sds_nav', '', local_o365_get_settings_nav_html('local_o365_sds')));
            ...
            try {
                ...
                if (!empty($schools)) {
                    ...
                    $sdssettings->add(new admin_setting_configmulticheckbox(
                        'local_o365/sdsschools', $label, $desc, $coursesyncdefault, $coursesynchoices
                    ));
                    ...
                    $schooldisabledactionoptions = [
                        ...
                        SDS_SCHOOL_DISABLED_ACTION_DISCONNECT => get_string(
                            'settings_sds_school_disabled_action_disconnect', 'local_o365'
                        ),
                    ];
                    ...
                    $sdssettings->add(new admin_setting_configcheckbox(
                        'local_o365/sdsenrolmentenabled', $label, $desc, '0'
                    ));
                    ...
                    $sdssettings->add(new admin_setting_configcheckbox(
                        'local_o365/sdssyncenrolmenttosds', $label, $desc, '0'
                    ));
                    ...
                    $sdssettings->add(new admin_setting_configselect(
                        'local_o365/sdsenrolmentteacherrole', $label, $desc, 3, $courseroleoptions
                    ));
                    ...
                    $sdssettings->add(new admin_setting_configselect(
                        'local_o365/sdsenrolmentstudentrole', $label, $desc, 5, $courseroleoptions
                    ));
                    ...
                    $sdssettings->add(new admin_setting_configselect(
                        'local_o365/sdsprofilesync', $label, $desc, '0', $profilesyncchoices
                    ));
                } else {
        ...
        $teamssettings->add(new admin_setting_heading('local_o365_teams_nav', '', local_o365_get_settings_nav_html('local_o365_teams')));
        ...
        if (local_o365_show_teams_moodle_app_id_tab()) {
            ...
            $moodleappsettings->add(new admin_setting_heading('local_o365_moodle_app_nav', '', local_o365_get_settings_nav_html('local_o365_moodle_app')));
                ...
                if ($graphclient) {
                    ...
                    if ($moodleappid) {
                        $moodleappiddescription .= get_string(
                            'settings_moodle_app_id_desc_auto_id', 'local_o365', $moodleappid
                        );
                    }
                }
            }
            ...
            if (\local_o365\utils::is_connected() === true) {
                ...
                $moodleappsettings->add(new admin_setting_heading(
                    'set_moodle_app_id_instruction_header', '', $setmoodleappidinstructionhtml
                ));
            }
        }
    }
