...
$string['settings_azuresetup_legacydesc'] = 'Microsoft 365 APIはアプリケーション固有のAPIで構成されています。';
$string['settings_azuresetup_legacyerror'] = 'Microsoft 365 API設定の確認中にエラーが発生しました。';
...
$string['settings_sharepointlink_details'] = 'MoodleとSharePointを接続するには、Moodleが接続するSharePointサイトの完全URLを入力します。サイトが存在しない場合、Moodleはその作成を試みます。<br /><a href="https://docs.moodle.org/30/en/Office365/SharePoint"> MoodleとSharePointの接続についての詳細をご覧ください。</a>';
...
$string['task_groupcreate'] = 'Microsoft 365にユーザグループを作成する';
