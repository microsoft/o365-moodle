...
$string['settings_systemapiuser_details'] = 'Dowolny użytkownik usługi Microsoft Entra ID, ale powinno to być konto administratora lub konto dedykowane. To konto jest wykorzystywane do wykonywania operacji, które nie dotyczą konkretnego użytkownika, np. do zarządzania witrynami programu SharePoint w kursie.';
