...
$string['settings_usersync'] = 'Synkronoi käyttäjät Microsoft Entra ID:n kanssa';
$string['settings_usersync_details'] = 'Kun asetus on käytössä, Moodle- ja Microsoft Entra ID -käyttäjät synkronoidaan edellä olevien asetusten mukaisesti.<br /><br /><b>Huomautus: </b>Synkronointityö suoritetaan Moodlen cron-prosessin aikana, ja enintään 1 000 käyttäjää voidaan synkronoida kerralla. Työ suoritetaan oletusarvoisesti klo 1:00 palvelimen aikavyöhykkeen mukaisesti. Jos suuria käyttäjäjoukkoja on synkronoitava nopeasti, lyhennä <b>Synkronoi käyttäjät Microsoft Entra ID:n kanssa</b> -tehtävän suoritusväliä <a href="{$a}">ajoitettujen tehtävien hallintasivulla.</a><br /><br />Lisätietoja on <a href="https://docs.moodle.org/30/en/Office365#User_sync">käyttäjien synkronointia käsittelevissä ohjeaiheissa</a><br /><br />';
$string['settings_usersync_create'] = 'Luo Microsoft Entra ID -käyttäjille tilit Moodlessa';
$string['settings_usersync_delete'] = 'Poista aiemmin synkronoidut tilit Moodlesta, kun tilit poistetaan Microsoft Entra ID:stä';
$string['settings_usersync_match'] = 'Yhdistä nykyiset Moodle-käyttäjät samannimisiin Microsoft Entra ID -tileihin<br /><small>Tämä tarkistaa Microsoft 365 -käyttäjänimet ja Moodle-käyttäjänimet ja etsii niiden vastaavauudet. Vastaavuuksien etsintä ei erota kirjainkokoa eikä Microsoft 365 -vuokraajatunnusta. Esimerkiksi Moodlen käyttäjätunnus BoB.SmiTh täsmää käyttäjätunnukseen bob.smith@example.onmicrosoft.com. Vastaavien käyttäjien Moodle- ja Microsoft 365-tilit yhdistetään ja kyseiset käyttäjät voivat käyttää Microsoft 365:n ja Moodlen integrointitoimintoja. Käyttäjän todennusmenetelmä ei muutu, ellei alla olevaa asetusta oteta käyttöön.</small>';
$string['settings_usersync_matchswitchauth'] = 'Vaihda vastaavien käyttäjien todennustavaksi Microsoft 365 (OpenID Connect)<br /><small>Tämän asetuksen käyttäminen edellyttää, että yllä oleva yhdistämisasetus on käytössä. Tämän asetuksen ottaminen käyttöön vaihtaa yhdistettyjen käyttäjien todennustavaksi OpenID Connectin. Kun käyttäjälle löytyy vastaavauus, käyttäjän todennustavaksi muutetaan OpenID Connect. Tämän jälkeen käyttäjä kirjautuu Moodleen käyttämällä Microsoft 365 -tunnistetietoja. <b>Huomautus:</b> Varmista, että OpenID Connect -todennuslisäosa on otettu käyttöön, jos haluat käyttää tätä asetusta.</small>';
$string['settings_entratenant'] = 'Microsoft Entra ID -vuokraaja';
$string['settings_entratenant_details'] = 'Määritä tähän organisaation Microsoft Entra ID vuokraajatunnus, esimerkiksi contoso.onmicrosoft.com.';
$string['settings_verifysetup'] = 'Tarkista määritykset';
$string['settings_verifysetup_details'] = 'Tämä työkalu tarkistaa, että kaikki Azure-asetukset on määritetty oikein. Se voi myös auttaa korjaamaan yleisiä virheitä.';
$string['settings_verifysetup_update'] = 'Päivitä';
$string['settings_verifysetup_checking'] = 'Tarkistetaan...';
$string['settings_verifysetup_missingperms'] = 'Puuttuvat käyttöoikeudet:';
$string['settings_verifysetup_permscorrect'] = 'Käyttöoikeudet ovat riittävät.';
$string['settings_verifysetup_errorcheck'] = 'Azure-määritysten tarkistamisen aikana tapahtui virhe.';
$string['settings_verifysetup_unifiedheader'] = 'Yhdistetty ohjelmointirajapinta';
$string['settings_verifysetup_unifieddesc'] = 'Yhdistetty ohjelmointirajapinta korvaa aiemmat sovelluskohtaiset ohjelmointirajapinnat. Jos mahdollista, lisää tämä rajapinta jo nyt Azure-sovellukseen, jotta sovellus on valmis tulevia muutoksia varten. Vanha ohjelmointirajapinta poistetaan käytöstä myöhemmin.';
$string['settings_verifysetup_unifiederror'] = 'Yhdistetyn ohjelmointirajapinnan tuen tarkistuksessa tapahtui virhe.';
$string['settings_verifysetup_unifiedactive'] = 'Yhdistetty ohjelmointirajapinta on aktiivinen.';
$string['settings_verifysetup_unifiedmissing'] = 'Tästä sovelluksesta ei löytynyt yhdistettyä ohjelmointirajapintaa.';
...
$string['settings_detectperms_details'] = 'Tämän lisäosan toimintojen käyttäminen edellyttää asianmukaisten käyttöoikeuksien määrittämistä sovellukselle Microsoft Entra ID:ssä.';
...
$string['settings_detectperms_invalid'] = 'Tarkasta oikeudet Microsoft Entra ID:ssä';
...
$string['settings_systemapiuser_details'] = 'Tämä voi olla kuka tahansa Microsoft Entra ID -käyttäjä, jolla on järjestelmänvalvojan tili tai erityinen tili. Tiliä käytetään muiden kuin käyttäjäkohtaisten toimintojen tekemiseen, esimerkiksi kurssin SharePoint-sivustojen hallintaan.';
...
$string['task_syncusers'] = 'Synkronoi käyttäjät Microsoft Entra ID:n kanssa.';
...
$string['ucp_index_entraidlogin_title'] = 'Microsoft 365 -kirjautuminen';
$string['ucp_index_entraidlogin_desc'] = 'Voit kirjautua Moodleen käyttämällä Microsoft 365 -tunnistetietojasi. ';
