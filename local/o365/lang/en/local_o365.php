...
$string['settings_manifest_external_id'] = 'Value of "externalId" field in manifest file';
$string['settings_manifest_external_id_desc'] = 'Leave as default unless otherwise suggested.';
$string['settings_download_teams_tab_app_manifest'] = 'Download manifest file';
$string['settings_publish_manifest_instruction_1'] = 'Click here';
$string['settings_publish_manifest_instruction_2'] = ' to learn how to publish your downloaded Moodle app manifest file to all users in Teams.';
$string['settings_teams_banner_1'] = 'The Moodle app for {$a} allows you to easily access and collaborate around your Moodle courses in Teams. The Moodle app also consists of a Moodle Assistant bot, which will send Moodle notifications to students and teachers and answer questions about their courses, assignments, grades and students -- right within Teams!';
$string['settings_teams_link_teams'] = 'Microsoft Teams';
$string['settings_teams_banner_2'] = 'To provision the Moodle Assistant Bot for your Office 365 tenant, you need to deploy it to {$a->link1}. If you don\'t have an active Azure subscription, you can {$a->link2} today!';
$string['settings_teams_link_azure_1'] = 'Microsoft Azure';
$string['settings_teams_link_azure_2'] = 'get one for free';
