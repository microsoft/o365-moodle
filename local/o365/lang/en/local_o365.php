...
$string['acp_maintenance_createclassnotebooks'] = 'Replace group notebooks with class notebooks';
$string['acp_maintenance_createclassnotebooks_desc'] = 'Replace the simple notebook of all Office 365 groups with class notebooks.';
