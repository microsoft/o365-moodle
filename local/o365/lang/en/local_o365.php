...
$string['help_user_create_help'] = 'This will create users in Moodle from each user in the linked Azure Active Directory. Only users which do not currently have Moodle accounts will have accounts created. New accounts will be set up to use their Office 365 credentials to log in to Moodle, and will be able to use all the features of the Office 365 plugin set.';
$string['help_user_delete'] = 'Delete Accounts Help';
$string['help_user_delete_help'] = 'This will delete users from Moodle if they are marked as deleted in Azure AD. The Moodle account will be deleted and all associated user information will be removed from Moodle. Be careful!';
$string['help_user_match'] = 'Match Accounts Help';
$string['help_user_match_help'] = 'This will look at the each user in the linked Azure Active Directory and try to match them with a user in Moodle. This looks for matching usernames in Azure AD and Moodle. Matches are case-insentitive and ignore the Office 365 tenant. Users who are matched will have their Moodle and Office accounts connected and will be able to use all Office 365/Moodle integration features.';
$string['help_user_matchswitchauth'] = 'Switch Accounts Help';
...
$string['help_user_appassign'] = 'Assigning Users To App Help';
$string['help_user_appassign_help'] = 'This will assign Azure AD users to application in Azure during sync if not already assigned';
$string['help_user_photosync'] = 'Sync Office 365 Profile Photo Help';
$string['help_user_photosync_help'] = 'This will sync Office 365 profile photo with Moodle profile photo in cron job for all users';
$string['help_user_photosynconlogin'] = 'Sync Office 365 Profile Photo Help';
$string['help_user_photosynconlogin_help'] = 'This will sync Office 365 profile photo with Moodle profile photo on login for all users';