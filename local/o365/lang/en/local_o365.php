...
$string['settings_setup_step1_end'] = 'Note: These settings are saved in the OpenID Connect authentication plugin. To configure advanced login settings, go to the <a href="{$a->oidcsettings}">OpenID Connect settings page</a><br /><br /><br />';
...
$string['settings_setup_step2_desc'] = 'This section allows you to choose how the Office 365 integration suite connects to Azure. Communication can be made using "Application Access", or on behalf of a user you have dedicated as the "system" user. Each option is described below:';
$string['settings_setup_step2_continue'] = '<b>Choose a connection method, then click "Save changes" to continue.</b><br /><br /><br /><br /><br />';
$string['settings_setup_step3'] = 'Step 3/3: Admin consent, detect additional information, and verify your setup';
