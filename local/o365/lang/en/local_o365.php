...
$string['settings_aadsync_idsync'] = 'Update moodle usernames when updating or syncing users from Azure AD';
...
$string['help_user_idsync'] = 'Sync azure usernames with object Help';
$string['help_user_idsync_help'] = 'Enabling this option will change moodle users username when username is changed in Azure AD.';
