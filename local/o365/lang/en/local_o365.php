...
$string['settings_bot_sharedsecret'] = 'Shared secret for bot';
$string['settings_bot_sharedsecret_desc'] = 'This the shared secret which should be also added to bot settings';
