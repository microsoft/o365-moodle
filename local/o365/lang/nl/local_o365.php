...
$string['settings_systemapiuser_details'] = 'Willekeurige Microsoft Entra ID-gebruiker, maar het moet wel een beheerdersaccount zijn of een speciaal daarvoor bestemd account. Dit account wordt gebruikt om bewerkingen uit te voeren die niet gebruikerspecifiek zijn, zoals het beheren van SharePoint-sites voor cursussen.';
