...
$string['settings_systemapiuser_details'] = 'Cualquier usuario de Microsoft Entra ID, pero debe ser la cuenta de un administrador o una cuenta dedicada. Esta cuenta se utiliza para realizar operaciones no específicas del usuario. Por ejemplo, administrar sitios de SharePoint de cursos.';
