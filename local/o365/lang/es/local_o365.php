...
$string['settings_azuresetup_legacyheader'] = 'API de Microsoft 365';
$string['settings_azuresetup_legacydesc'] = 'La API de Microsoft 365 está compuesta de API específicas de la aplicación.';
$string['settings_azuresetup_legacyerror'] = 'Ocurrió un error al verificar la configuración de la API de Microsoft 365.';
