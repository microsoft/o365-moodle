...
$string['settings_usersync'] = 'Sincronizza utenti con Microsoft Entra ID';
$string['settings_usersync_details'] = 'Abilitando questa opzione, gli utenti Moodle e Microsoft Entra ID vengono sincronizzati in base alle opzioni precedenti.<br /><br /><b>Nota: </b>il processo di sincronizzazione viene eseguito nel cron Moodle e sincronizza 1000 utenti alla volta. Per default, viene eseguito una volta al giorno alle 1:00 nel fuso orario locale per il server. Per sincronizzare grandi insiemi di utenti più rapidamente, è possibile incrementare la frequenza dell\'attività <b>Sincronizza utenti con Microsoft Entra ID</b> utilizzando la <a href="{$a}">pagina di gestione delle attività pianificate.</a><br /><br />Per istruzioni più dettagliate, consultare la <a href="https://docs.moodle.org/30/en/Office365#User_sync">documentazione di sincronizzazione utente</a><br /><br />';
$string['settings_usersync_create'] = 'Crea account in Moodle per utenti in Microsoft Entra ID';
$string['settings_usersync_delete'] = 'Elimina gli account sincronizzati in precedenza in Moodle quando vengono eliminati da Microsoft Entra ID';
$string['settings_usersync_match'] = 'Trova corrispondenza tra utenti Moodle preesistenti e account con lo stesso nome in Microsoft Entra ID<br /><small>Questa opzione consente di trovare delle corrispondenze confrontando il nome utente di Microsoft 365 con quello di Moodle. La ricerca delle corrispondenze tiene conto di maiuscole e minuscole, mentre ignora il tenant Microsoft 365. Ad esempio, viene rilevata la corrispondenza tra il nome utente BoB.SmiTh di Moodle e bob.smith@example.onmicrosoft.com. Gli utenti con corrispondenza potranno utilizzare tutte le funzioni di integrazione di Microsoft 365/Moodle e i loro account di Microsoft 365 e Moodle verranno connessi. Il metodo di autenticazione di tali utenti non subirà modifiche, salvo nel caso in cui l\'impostazione indicata sotto venga abilitata.</small>';
$string['settings_usersync_matchswitchauth'] = 'Converti gli utenti con corrispondenza all\'autenticazione di Microsoft 365 (OpenID Connect)<br /><small>Questa operazione richiede l\'attivazione dell\'impostazione "Corrispondenza". Quando viene trovata la corrispondenza per l\'utente, attivando questa impostazione si converte il metodo di autenticazione dell\'utente su OpenID Connect. In questo modo, l\'utente potrà accedere a Moodle con le sue credenziali di Microsoft 365. <b>Nota:</b> verifica che il plugin di autenticazione di OpenID Connect sia abilitato se desideri utilizzare questa impostazione.</small>';
$string['settings_entratenant'] = 'Tenant Microsoft Entra ID';
$string['settings_entratenant_details'] = 'Utilizzato per identificare l\'organizzazione all\'interno di Microsoft Entra ID. Ad esempio: "contoso.onmicrosoft.com"';
$string['settings_verifysetup'] = 'Verificare la configurazione';
$string['settings_verifysetup_details'] = 'Questo strumento esegue la verifica in Azure per assicurarsi che le impostazioni siano corrette. Può anche correggere alcuni errori comuni.';
$string['settings_verifysetup_update'] = 'Aggiorna';
$string['settings_verifysetup_checking'] = 'Verifica in corso...';
$string['settings_verifysetup_missingperms'] = 'Autorizzazioni mancanti:';
$string['settings_verifysetup_permscorrect'] = 'Le autorizzazioni sono corrette.';
$string['settings_verifysetup_errorcheck'] = 'Errore durante il tentativo di verifica dell\'impostazione Azure.';
$string['settings_verifysetup_unifiedheader'] = 'API unificata';
$string['settings_verifysetup_unifieddesc'] = 'L\'API unificata sostituisce le API specifiche delle applicazioni esistenti. Se disponibile, aggiungere questa API all\'applicazione Azure per la compatibilità futura. L\'API precedente verrà sostituita dall\'API unificata.';
$string['settings_verifysetup_unifiederror'] = 'Si è verificato un errore durante la verifica del supporto API unificata.';
$string['settings_verifysetup_unifiedactive'] = 'API unificata attiva.';
$string['settings_verifysetup_unifiedmissing'] = 'L\'API unificata non è stata trovata per questa applicazione.';
...
$string['settings_detectperms_details'] = 'Per utilizzare le funzioni di plugin è necessario impostare le autorizzazioni corrette per l\'applicazione in Microsoft Entra ID.';
...
$string['settings_detectperms_invalid'] = 'Verifica autorizzazioni in Microsoft Entra ID';
...
$string['settings_systemapiuser_details'] = 'Qualsiasi utente Microsoft Entra ID, ma deve essere l\'account di un amministratore, o un account dedicato. Questo account viene utilizzato per eseguire operazioni che non sono specifiche dell\'utente. Ad esempio, la gestione dei siti SharePoint del corso.';
...
$string['task_syncusers'] = 'Sincronizza utenti con Microsoft Entra ID.';
...
$string['ucp_index_entraidlogin_title'] = 'Login a Microsoft 365';
$string['ucp_index_entraidlogin_desc'] = 'Puoi utilizzare le tue credenziali di Microsoft 365 per accedere a Moodle. ';
