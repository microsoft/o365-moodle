...
$string['settings_systemapiuser_details'] = 'Jakýkoli uživatel Microsoft Entra ID, ale mělo by jít buď o účet administrátora, nebo o vyhrazený účet. Tento účet se používá k provádění operací, které nejsou specifické pro uživatele, například ke správě webů SharePoint kurzu.';
