...
$string['settings_sharepointlink_details'] = 'MoodleとSharePointを接続するには、Moodleが接続するSharePointサイトの完全URLを入力します。サイトが存在しない場合、Moodleはその作成を試みます。<br /><a href="https://docs.moodle.org/29/en/Office365/SharePoint"> MoodleとSharePointの接続についての詳細をご覧ください。</a>';
...
$string['settings_onenote'] = 'Office&nbsp;365 OneNoteを無効にする';
