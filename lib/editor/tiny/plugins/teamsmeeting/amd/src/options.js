...
/**
 * Return the opaque token to be forwarded to the Teams app and back to result.php,
 * where it authenticates the request in place of the (possibly dropped) session cookie.
 *
 * @param {tinyMCE} editor The editor instance to fetch the value for.
 * @returns {string} The opaque token string.
 */
