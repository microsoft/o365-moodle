...
function xmldb_tiny_teamsmeeting_upgrade($oldversion) {
    ...
    if ($oldversion < 2025100207.01) {
        ...
        upgrade_plugin_savepoint(true, 2025100207.01, 'tiny', 'teamsmeeting');
    }

    if ($oldversion < 2025100207.02) {
        $table = new xmldb_table('tiny_teamsmeeting');
        ...
        upgrade_plugin_savepoint(true, 2025100207.02, 'tiny', 'teamsmeeting');
    }

    if ($oldversion < 2025100208.01) {
        ...
        upgrade_plugin_savepoint(true, 2025100208.01, 'tiny', 'teamsmeeting');
    }
