...
function xmldb_tiny_teamsmeeting_upgrade($oldversion) {
    ...
    if ($oldversion < 2025100307.02) {
        ...
        upgrade_plugin_savepoint(true, 2025100307.02, 'tiny', 'teamsmeeting');
    }

    if ($oldversion < 2025100308.01) {
        ...
        upgrade_plugin_savepoint(true, 2025100308.01, 'tiny', 'teamsmeeting');
    }
