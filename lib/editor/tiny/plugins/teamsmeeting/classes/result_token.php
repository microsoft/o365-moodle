 ...
 * the browser may not send the Moodle session cookie on the request. This
 * token lets result.php identify the acting user without depending on that
 * cookie.
 *
...
class result_token {
    ...
    const SCRIPT = 'tiny_teamsmeeting_result';
