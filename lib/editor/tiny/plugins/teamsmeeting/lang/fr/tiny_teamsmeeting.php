...
/**
 * Strings for component 'tiny_teamsmeeting', language 'fr'.
 *
...
$string['settings_meetings_app_link_desc'] = 'Il s’agit de l’URL de l’application Réunions.';
...
$string['iframe_go_to_meeting'] = 'Accéder à la réunion';
...
$string['invalidtoken'] = 'Le jeton de rappel de la réunion est manquant, invalide ou a expiré. Fermez cette fenêtre et essayez de créer à nouveau la réunion.';
...
// Privacy subsystem.
$string['privacy:metadata'] = 'Le plugin Tiny Teams Meeting enregistre les réunions créées par les utilisateurs, y compris l’identifiant de l’utilisateur et le contexte dans lequel chaque réunion a été créée.';
$string['privacy:metadata:tiny_teamsmeeting'] = 'Détails des réunions Teams créées via l’éditeur TinyMCE.';
...
$string['privacy:metadata:tiny_teamsmeeting:link'] = 'L’URL de participation à la réunion.';
...
$string['privacy:metadata:msteamsapp'] = 'Afin de créer une réunion, le plugin Tiny Teams Meeting échange des données avec l’application de réunions Microsoft Teams.';
