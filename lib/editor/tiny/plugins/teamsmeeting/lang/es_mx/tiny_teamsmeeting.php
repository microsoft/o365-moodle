...
/**
 * Strings for component 'tiny_teamsmeeting', language 'es_mx'.
 *
...
$string['iframe_meeting_created'] = '¡La reunión "{$a}" se creó correctamente!';
$string['iframe_meeting_details'] = 'Reunión "{$a}"';
$string['iframe_go_to_meeting'] = 'Ir a la reunión';
$string['iframe_add_link'] = 'Agregar vínculo';
$string['iframe_new_window_label'] = 'Abrir la reunión en una ventana nueva';
$string['iframe_not_found'] = 'No se encontró la reunión';
$string['invalidtoken'] = 'El token de devolución de llamada de la reunión falta, no es válido o expiró. Cierra esta ventana e intenta crear la reunión de nuevo.';
...
// Privacy subsystem.
$string['privacy:metadata'] = 'El plugin Tiny Teams Meeting almacena los registros de las reuniones creadas por los usuarios, incluido el ID del usuario y el contexto en el que se creó cada reunión.';
$string['privacy:metadata:tiny_teamsmeeting'] = 'Detalles de las reuniones de Teams creadas mediante el editor TinyMCE.';
$string['privacy:metadata:tiny_teamsmeeting:userid'] = 'El ID del usuario que creó la reunión.';
...
$string['privacy:metadata:tiny_teamsmeeting:link'] = 'La URL para unirse a la reunión.';
...
$string['privacy:metadata:msteamsapp'] = 'Para crear una reunión, el plugin Tiny Teams Meeting intercambia datos con la aplicación de reuniones de Microsoft Teams.';
$string['privacy:metadata:msteamsapp:courseid'] = 'El ID del curso en el que se crea la reunión se envía a la aplicación de reuniones de Microsoft Teams.';
$string['privacy:metadata:msteamsapp:moodleurl'] = 'La URL de este sitio Moodle se envía a la aplicación de reuniones de Microsoft Teams para que pueda devolver el vínculo de la reunión al lugar correcto.';
