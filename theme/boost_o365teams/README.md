...
## Boost O365 Teams Theme

This plugin provides a Microsoft Teams-integrated theme for Moodle, designed to provide a seamless experience for users working within Microsoft Teams.
...
1. Unpack the plugin into /theme/boost_o365teams within your Moodle install.
2. From the Moodle Administration block, expand Site Administration and click "Notifications".
3. Follow the on-screen instructions to install the plugin.
4. From the Moodle Administration block, go to Site Administration > Appearance > Themes > Theme selector and choose "Boost O365 Teams".
