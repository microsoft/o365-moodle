...
/*
 * Get github code and call the normal login page
...
if (empty($code)) {
    throw new moodle_exception('github_failure');
}
...
$url = new moodle_url($loginurl, array('code' => $code, 'authprovider' => 'github'));
redirect($url);
?>
